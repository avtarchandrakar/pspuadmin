                       ...
                       <tbody>
                        <?php
                            ...
                            foreach($all_value as $value){
                                $edit_link= site_url('Location/edit_city?edid=').$value->m_city_id;
                            ?>   
                               <tr>
                                 <td><?php echo $i;?></td>
                                 ...
                                 <td title="Action" style="white-space: nowrap;">
                                    ...
                                    <button class="btn btn-danger btn-action delete-data" data-value="<?php echo $value->m_city_id; ?>" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></button>
                                  </td>
                               </tr>
                            <?php
                            $i++;
