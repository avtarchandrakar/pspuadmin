...
//===========================/officer============================//
  ...
  $("#frm-officer-create").submit(function(e) { e.preventDefault();
      var clkbtn = $("#btn-officer-create"); clkbtn.prop('disabled',true);
 ...
 $("#custom_tbl").on("click",".delete-officer-data",function(){ 
  ...
  swal({
      ...
      if (willDelete) {
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url('Officer/delete_officer_dtl'); ?>",
