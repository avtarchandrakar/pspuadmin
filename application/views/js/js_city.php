<script type="text/javascript"> $(document).ready(function(e){
 ...
 $("#frm-add-data").submit(function(e) { e.preventDefault();
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('Location/insert_city'); ?>",
    data: formData,
    processData: false,
    contentType: false,
    dataType: "JSON", 
    success: function(data) {
      if(data.status=='success'){
        ...
        setTimeout(function(){
          window.location = "<?php echo site_url('Location/city'); ?>"; 
        },1000);
...
$("#frm-update-data").submit(function(e) { e.preventDefault();
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('Location/update_city'); ?>",
    data: formData,
    processData: false,
    contentType: false,
    dataType: "JSON", 
...
$("#custom_tbl").on("click",".delete-data",function(){ 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Location/delete_city'); ?>",
