...
//===========================/post============================//
  ...
  $("#frm-post-create").submit(function(e) { e.preventDefault();
      var clkbtn = $("#btn-post-create"); clkbtn.prop('disabled',true);
      var formData = new FormData(this); 
      
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('post/insert_post_dtl'); ?>",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "JSON", 
        success: function(data) {
          if(data.status=='success'){
            ...
            setTimeout(function(){
              window.location = "<?php echo site_url('post/post_list'); ?>"; 
            },1000);
 ...
 $("#custom_tbl").on("click",".delete-post-data",function(){ 
  ...
  swal({
      ...
      if (willDelete) {
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url('post/delete_post_dtl'); ?>",
