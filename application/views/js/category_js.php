...
$("#frm-category-create").submit(function(e) { e.preventDefault();
      var clkbtn = $("#btn-category-create"); clkbtn.prop('disabled',true);
      var formData = new FormData(this); 
      
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('Master/insert_category_dtl'); ?>",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "JSON", 
  ...
  $("#custom_tbl").on("click",".delete-category-data",function(){ 
  ...
  swal({
      ...
      if (willDelete) {
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url('Master/delete_category_dtl'); ?>",
