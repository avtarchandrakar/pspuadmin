                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="hidden" name="m_city_id" value="<?php echo $a_value[0]->m_city_id;?>">
                                 <select name="m_city_state" id="m_city_state" class="form-control select2" title="Select Status" required>
                                    ...
                                    if(!empty($get_active_state)){
                                       ...
                                       ?>
                                       <option value="<?php echo $state->m_state_id;?>" <?php if($a_value[0]->m_city_state==$state->m_state_id) echo 'selected';?>><?php echo $state->m_state_name;?></option>
                                       <?php
                                       }
                                    } 
                                    ?>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="m_city_name" id="m_city_name" class="form-control"  placeholder=" Enter City Name" required="" value="<?php echo $a_value[0]->m_city_name;?>" >
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <select name="m_city_status" id="m_city_status" class="form-control" title="Select Status" required>
                                    <option value="1" <?php if($a_value[0]->m_city_status==1) echo 'selected';?>>Active</option>
                                    <option value="0" <?php if($a_value[0]->m_city_status==0) echo 'selected';?>>In-Active</option>
                                 </select>
                              </div>
                           </div>
                        </div>
