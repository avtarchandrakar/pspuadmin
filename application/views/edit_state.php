                        ...
                        <div class="row">
                           <div class="col-md-8">
                              <div class="form-group">
                                 ...
                                 <input type="hidden" name="m_state_id" value="<?php echo $a_value[0]->m_state_id;?>">
                                 <input type="text" name="m_state_name" id="m_state_name" class="form-control"  placeholder=" Enter Name" required="" value="<?php echo $a_value[0]->m_state_name;?>">
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <select name="m_state_status" id="m_state_status" class="form-control" title="Select Status" required>
                                    <option value="1" <?php if($a_value[0]->m_state_status==1) echo 'selected';?>>Active</option>
                                    <option value="0" <?php if($a_value[0]->m_state_status==0) echo 'selected';?>>In-Active</option>
                                 </select>
                              </div>
                           </div>
                        </div>
